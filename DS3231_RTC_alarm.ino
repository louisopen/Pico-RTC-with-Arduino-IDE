...
void setup() {
    ...
    Serial.println("---RTC DS3231 on Pico test---");
    /* Wire I2C bus 0 */
    Wire.setSDA(20);  //Wire I2C0 SDA GP0/GP4/GP8/GP12/GP16/GP20
    Wire.setSCL(21);  //Wire I2C0 SCL GP1/GP5/GP9/GP13/GP17/GP21 
    //Wire.begin();
    /* Wire I2C bus 1 */
    //Wire1.setSDA(6);   //Wire1 I2C1 SDA GP2/GP6/GP10/GP14/GP18/GP26
    //Wire1.setSCL(7);   //Wire1 I2C1 SCL GP3/GP7/GP11/GP15/GP19/GP27 
    //Wire1.begin();
